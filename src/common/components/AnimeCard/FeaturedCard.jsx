...
const FeaturedCard = ({ items, custom_link, pause }) => {
  ...
  return (
    ...
    >
      <div className='absolute -top-10 right-0 flex gap-2 z-10 bg-base-100'>
        <button
          onClick={handlePrev}
          ...
          items.map((item, index) => (
            ...
            >
              ...
              <div className='absolute inset-0 bg-black/0 group-hover:bg-black/70 flex items-center justify-center transition-all duration-300'>
                <h1 className='text-green-300 opacity-0 group-hover:opacity-100 text-center text-sm sm:text-lg font-bold transition-opacity duration-300'>
